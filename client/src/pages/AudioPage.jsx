                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        {filteredAudios.map(audio => (
                            ...
                            >
                                ...
                                <h2 className="text-center font-semibold text-md mb-2">{audio.name}</h2> {/* Display audio name */}
                                <h3 className="text-center font-normal text-sm">{audio.desc}</h3> {/* Display audio description */}
                            </div>
                        ))}
                    </div>
                </>
